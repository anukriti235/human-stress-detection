...
df.columns = ['snoring_rate','respiration_rate','body_temperature','sleeping_hours','heart_rate','stress_level']

df_train, df_val = train_test_split(df, test_size=0.40, random_state=1, stratify=df.stress_level)

# check the notebook for feature selection
most_importan_features = ['heart_rate', 'sleeping_hours', 'snoring_rate', 'body_temperature']
